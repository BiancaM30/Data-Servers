...
SELECT constraint_name, constraint_type, table_name, search_condition FROM user_constraints WHERE table_name = 'CAFES';
SELECT index_name, table_name, uniqueness FROM user_indexes WHERE table_name = 'CAFES';
SELECT column_name, data_type FROM user_tab_columns WHERE table_name = 'CAFES';

SELECT constraint_name, constraint_type, table_name, search_condition FROM user_constraints WHERE table_name = 'SUPPLIERS';
SELECT index_name, table_name, uniqueness FROM user_indexes WHERE table_name = 'SUPPLIERS';
SELECT column_name, data_type FROM user_tab_columns WHERE table_name = 'SUPPLIERS';

SELECT constraint_name, constraint_type, table_name, search_condition FROM user_constraints WHERE table_name = 'CAFES_SUPPLIERS';
SELECT index_name, table_name, uniqueness FROM user_indexes WHERE table_name = 'CAFES_SUPPLIERS';
